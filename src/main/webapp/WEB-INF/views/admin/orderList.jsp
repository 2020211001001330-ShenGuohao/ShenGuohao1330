			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.ShenGuohao.model.Order o=(com.ShenGuohao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ShenGuohao.dao.UserDao userDao=new com.ShenGuohao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ShenGuohao.model.Payment.findByPaymentId(con,n);
							 %>
